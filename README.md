...
- **LLM-powered Agent**: Uses LangChain 1.0 with ChatOllama for tool-calling agent with intelligent interactions
- **Tool Decorators**: Simple `@tool` decorated functions for direct MCP server integration
